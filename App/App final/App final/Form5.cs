...
namespace Nhap_7
{
    public partial class Form5 : Form
    {
        ...
        private void timer1_Tick_1(object sender, EventArgs e)
        {
            ...
            var smoothedSpeedVals = ApplyMovingAverage(ySpeedVals, 10);
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                if (label != null)
                {
                    ...
                    if (tP[i] < 30.0) // Nhiệt độ dưới 30 độ
                    {
                        label.BackColor = Color.LightGreen;
                    }
                    else if (tP[i] >= 30.0 && tP[i] < 32.0) // Nhiệt độ từ 30 đến dưới 32 độ
                    {
                        label.BackColor = Color.Yellow;
                    }
                    else if (tP[i] >= 32.0 && tP[i] < 34.0)// Nhiệt độ từ 32-34
                    {
        ...
        private void txbrx_TextChanged(object sender, EventArgs e)
        {

        }

        private void btnoview_Click(object sender, EventArgs e)
        {
